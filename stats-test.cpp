...
TEST_CASE("average is NaN for empty array") {
    ...
    REQUIRE_THROWS(computedStats.average!=computedStats.average);
    REQUIRE_THROWS(computedStats.max!=computedStats.max);
    REQUIRE_THROWS(computedStats.min!=computedStats.min);
